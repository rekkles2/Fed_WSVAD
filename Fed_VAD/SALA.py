...
# https://github.com/TsingZ0/FedALA/blob/main/system/utils/ALA.py
# which is licensed under the Apache License, Version 2.0:
# http://www.apache.org/licenses/LICENSE-2.0
#
# Modifications and extensions were made by Jiahang Li (2025),
# as part of the Fed_WSVAD project:
...
class SALA:
    def __init__(self,
        ...
        Args:
            ...
            eta: Weight learning rate. Default: 0.1
            beta: Weight learning rate. Default: 0.1
