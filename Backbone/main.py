...
if __name__ == '__main__':
    ...
    with open("F:\datasets\Avenue dataset\shanghaitech.txt", "r") as file:
        ...
        for i in range(num_batches):
            ...
            for line in batch_lines:
                ...
                video = line
                source_folder = f"F:\datasets\shanghaitech dataset\shanghaitech_Dataset\shanghaitech_Dataset_frame\\{video}"
                ...
                copy_files(source_folder, target_folder) # Copy the file
                end_time = time.time()
                ...
                destination_folders = f'F:\\try\\avenue\\features_video\i3d\combine\\{video}'
