...
def i3d_function():
    ...
    a = 'flow'
    b = 'rgb'
    data_path = 'D:\Backbone'
    ckpt_path = 'D:\\VAD\Video_MAE\\vit_g_hybrid_pt_1200e_k710_ft.pth'
    ...
    origin_filelist2 = 'D:\Backbone\dataset\\shanghaitech\\i3d\\{}_list.txt'.format(datamodal2)
    origin_labellist = 'D:\Backbone\\dataset\\shanghaitech\\i3d\\label.txt'
